...
\begin{figure}[H]
   	\centering
    	\includegraphics[width=1\textwidth]{DiagramaClase.png}
...
\begin{figure}[H]
   	\centering
    	\includegraphics[width=0.15\textwidth, height=4cm]{IntrareDeTipTimp.png}
...
\begin{figure}[H]
   	\centering
    	\includegraphics[width=0.25\textwidth]{IntrareDeTipNumeric.png}
...
\begin{figure}[H]
   	\centering
    	\includegraphics[width=0.5\textwidth]{IntervalsWorkingDays.png}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=1\textwidth, height=4cm]{CoverageReport.png}
