...
\subsection{Cerințe funcționale pentru ansamblul de componente electronice}

\begin{figure}[H]
   	\centering
    	\includegraphics[width=1\textwidth]{Use-Case hardware.png}
	\caption{Cazurile de utilizare pentru ansamblul de componente electronice}
\end{figure}	

	Sistemul trebuie să poată funcționa și în cazul întreruperii conexiunii la internet. Într-o astfel de situație, componentele electronice trebuie să fie capabile să preia funcționalitățile de bază ale aplicației web, și anume: monitorizarea temperaturii și umidității, precum și setarea temperaturii.
